...
// @run-at      document-end
// @downloadURL https://raw.githubusercontent.com/MangelSpec/tampermonkey-scripts/main/rohlik-price-converter.user.js
    ...
    .forEach((wrap) => {
      ...
      if (mainPriceElement && fractionElement && currencyElement) {
        ...
        if (!isNaN(fullPriceCZK)) {
          ...
          // Change the currency element to €
